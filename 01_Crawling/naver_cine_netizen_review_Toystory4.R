...
start_url <- '/movie/bi/mi/point.nhn?code=101966#tab'
...
addWorksheet(wb, 'reviews_Toystory4')
writeDataTable(wb, 'reviews_Toystory4', df_reviews)
saveWorkbook(wb, file="D:/Workspace/R-project/01_Crawling/reviews_Toystory4.xlsx")
